...
excerpt: "How FMCL gained complete visibility across its FMCG, FOOD1, FOOD2, and CADBURY business verticals — replacing paper-based sub-distributor billing with a geo-tagged, offline-capable mobile sales platform serving over 30,000 neighborhood stores in Ghana with 70%+ of the SubD network onboarded within 
10 weeks of go-live."
...
tags:
  - fmcg-distribution
  - subd-management
  - route-to-market-automation
  - multi-tenant-saas
  - field-sales-mobile-app
  - ghana
metadata:
  title: "FMCL Ghana Case Study: Multi-Tenant SubD Management Solution"
  description: "How Fareast Mercantile Co. (FMCL) Ghana replaced paper-based sub-distributor billing with a multi-tenant mobile sales platform serving 30,000+ stores."
  canonical: https://www.upbuff.com/case-studies/fmcl-ghana-subd-management-case-study
---
...
| ROLLOUT | 70%+ SubDs onboarded within 10 weeks of go-live |
...
- **[FMCG Distribution](/industry/industry-solutions):** Distribution of products including branded food, personal care items, and beverages (Emborg, Kerrygold, ORO).
- **Appliances:** Distribution of appliance brands such as Scanfrost, Ignis, and Frigidaire.
- **Logistics & [Warehousing](/products/erp-integrated-warehouse-inventory):** Comprehensive supply chain management and warehousing services.
...
They are known for maintaining an extensive distribution network serving over **30,000 neighborhood stores in Ghana with 70%+ of the SubD network onboarded within 
10 weeks of go-live**.

## Operating Model & Business Verticals

FMCL operates across four main business verticals: **FMCG, FOOD1, FOOD2, and CADBURY**. Each vertical has its own Business Head, Business Development Manager and Manager-in-Charge to manage operations. They have a large network of [sub-distributors](/products/erp-integrated-sales-distribution) (SubDs) handling sales across Ghana.
...
Each SubD is provided with its own admin application for business management. They can add their sales teams and categorize them based on sales activities such as wholesale, open market, or van sales. The sales teams are provided with a [mobile sales application](/platform/why-upbuff) for daily operations.
...
<figure>
  <img src="/images/case-studies/fmcl-ghana/01-fmcl-admin-all-outlets.png" alt="FMCL Ghana admin portal — All Outlets listing screen with sub-distributor records showing code, name, contact, outlet type, class, and status columns" width="1104" height="409" loading="lazy" />
  <figcaption>Admin platform — sub-distributor outlet management across the SubD network</figcaption>
</figure>

<figure>
  <img src="/images/case-studies/fmcl-ghana/02-fmcl-admin-route-assign.png" alt="FMCL Ghana admin portal — Route Assign screen showing assigned distribution routes by sub-distributor with status indicators" width="1105" height="420" loading="lazy" />
  <figcaption>Admin platform — assigning daily routes to field sales representatives across SubDs</figcaption>
</figure>

<figure>
  <img src="/images/case-studies/fmcl-ghana/03-fmcl-mobile-distributor-app.png" alt="FMCL Ghana van sales mobile app on the TWO STREAMS delivery route — daily sales summary in Ghanaian cedi (cash sales, credit sales, orders), stock update widget, and route/outlets/orders navigation" width="231" height="499" loading="lazy" />
  <figcaption>Field sales mobile app — daily dashboard with sales summary, stock view, and quick navigation</figcaption>
</figure>
...
The platform was engineered as a **[multi-tenant system](/products/enterprise-partner-portals)** where each sub-distributor operates as an isolated tenant with its own admin layer, sales teams, and operational data — all unified under FMCL's head-office view.
...
- **[ERP Integration](/integrations/integrations) — Oracle:** Sales orders, dispatches, and SubD inventory remain aligned with FMCL's existing Oracle ERP without duplicate data entry.
...
Within 10 weeks of go-live, over 70% of FMCL's sub-distributor network was onboarded onto the platform — running daily attendance, route execution, stock movement, and outlet billing through the mobile sales app. With the majority of the SubD network  live, FMCL gained complete visibility across all four business verticals. Managers can now monitor:
...
If your distribution business is running paper-based sub-distributor operations and needs real-time visibility, the [UpBuff team](/contact) would be glad to show you how this platform could work for your network.
