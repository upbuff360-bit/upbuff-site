...
import { c as cleanSlug, P as POST_PERMALINK_PATTERN, t as trimSlash, S as SITE, M as METADATA, a as getPermalink } from '../chunks/permalinks_BLaU9d_x.mjs';
...
import { A as AstroError, U as UnknownContentCollectionError, R as RenderUndefinedEntryError, c as createComponent, u as unescapeHTML, a as renderTemplate, g as renderUniqueStylesheet, h as renderScriptElement, i as createHeadAndContent, r as renderComponent } from '../chunks/astro/server_BONdxEiL.mjs';
import 'piccolore';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('../chunks/_astro_data-layer-content_CrN8MFlF.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "PUBLIC_TURNSTILE_SITE_KEY": "0x4AAAAAADBpbFhP19dtePOt", "SITE": "https://upbuff-site.vercel.app", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('../chunks/_astro_assets_CjseGuOJ.mjs').then(n => n._);
